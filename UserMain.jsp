    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
			<li><a href="Request.jsp">REQUEST KEY PERMISSION </a></li>
  ...
  <div class="fbg">
    <div class="fbg_resize">
      ...
      <div class="col c3">
        ...
        <p class="style4">The efficient search algorithm proposed by DSMCC relies
